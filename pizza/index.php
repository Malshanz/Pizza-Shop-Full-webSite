...
<header class="header">
   ...
   <section class="flex">
      ...
      <a href="#home" class="logo">
         <img src="images/icon.png" style="width: 45px;"><span>P</span>izza Hub</a>
...
<div class="shopping-cart">
   ...
   <section>
      ...
      <a href="#order" class="btn" value="order now" name="order">order now</a>
...
<section class="about" id="about">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p>Let's make a pizza! Can you guess each ingredient as it's added? Soon the pizza will be ready to eat—overflowing with tasty toppings and piping hot, fresh out of the oven!</p>
      ...
      <div class="box">
         ...
         <p>'30 minutes or free' promise is eligible till the first barrier point (security guard/reception etc.) Pizza Hut reserves the right to withdraw the service promise without prior information.</p>
         <a href="#menu" class="btn">our menu</a>
      </div>
      ...
      <div class="box">
         ...
         <p>Our half-bake pizzas are standard large size 14” rounds. Delivery is included in the price, and your money stays local because we manage deliveries in-house.</p>
         <a href="#menu" class="btn">our menu</a>
      </div>
   ...
   <?php
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <input type="number" name="pin_code" class="box" required placeholder="e.g. 12345" min="0" max="999999" onkeypress="if(this.value.length == 6) return false;">
         </div>
      </div>
...
<section class="faq" id="faq">
   ...
   <div class="accordion-container">
      ...
      <div class="accordion active">
         ...
         Gamma Pizzakraft Lanka Pvt Ltd is the sole franchisee for Pizza Hut in Sri Lanka and the Maldives
         </p>
      </div>

      <div class="accordion">
         <div class="accordion-heading">
            <span>How many pizza Huts are there in Sri Lanka?</span>
            <i class="fas fa-angle-down"></i>
         </div>
         <p class="accrodion-content">
         At present, it is the largest in the restaurant industry in Sri Lanka, with a span of 97 outlets and a human capital of 2500+ passionate individuals.
         </p>
      </div>

      <div class="accordion">
         <div class="accordion-heading">
            <span>When did Pizza Hut come to Sri Lanka?</span>
            <i class="fas fa-angle-down"></i>
         </div>
         <p class="accrodion-content">
         Since its inception in 1993, Pizza Hut has fast become a household name across Sri Lanka. With its first restaurant at Union Place, Colombo 2, Pizza Hut became the first international restaurant chain to begin operations in Sri Lanka.
         </p>
      </div>

      <div class="accordion">
         <div class="accordion-heading">
            <span>Does Pizza Hut have the 30 minute rule?</span>
            <i class="fas fa-angle-down"></i>
         </div>
         <p class="accrodion-content">
...
<section class="footer">
   ...
   <div class="credit">
      &copy; copyright @ <?= date('Y'); ?> by <span>Madhuka Malshan</span> | all rights reserved!
   </div>
